        ...
        for (let item of Object.values(favoriteList)){
            containerHTML+=`
                ...
                <div class="card-image-container">
                    ...
                    <a href="/~hulevole/Zasuvka/client/edit.html?id=${item.id}" class="icon-btn edit-btn">
                    ...
                    <button id="remove_button" class="icon-btn delete-btn" title="Smazat" data-id="${item.id}">
                ...
                <div class="card-content">
                    <div class="card-header">
                     ...
                     <button class="view-button"><a href="/~hulevole/Zasuvka/client/product.html?id=${item.id}">Zobrazit</a></button>
                </div>
            </div>`
